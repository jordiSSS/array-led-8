...
void loop()
{
 ...
 {
  digitalWrite(led0, LOW);     // Led a 0V el pin 5
  digitalWrite(led1, HIGH);     // Led a 0V el pin 6
  digitalWrite(led2, LOW);     // Led a 0V el pin 7
  digitalWrite(led3, HIGH);     // Led a 0V el pin 8
  digitalWrite(led4, LOW);     // Led a 0V el pin 9
  digitalWrite(led5, HIGH);     // Led a 0V el pin 10
  digitalWrite(led6, LOW);     // Led a 0V el pin 11
  digitalWrite(led7, HIGH);     // Led a 0V el pin 12
  
  delay(500);    

  digitalWrite(led0, HIGH);     // Led a 0V el pin 5
  digitalWrite(led1, LOW);     // Led a 0V el pin 6
  digitalWrite(led2, HIGH);     // Led a 0V el pin 7
  digitalWrite(led3, LOW);     // Led a 0V el pin 8
  digitalWrite(led4, HIGH);     // Led a 0V el pin 9
  digitalWrite(led5, LOW);     // Led a 0V el pin 10
  digitalWrite(led6, HIGH);     // Led a 0V el pin 11
  digitalWrite(led7, LOW);     // Led a 0V el pin 12
